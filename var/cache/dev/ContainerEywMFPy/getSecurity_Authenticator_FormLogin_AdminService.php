...
class getSecurity_Authenticator_FormLogin_AdminService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c->setOptions(['login_path' => 'app_admin_login', 'default_target_path' => 'app_admin_dashboard', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false]);
        ...
        $instance = new \Symfony\Component\Security\Http\Authenticator\FormLoginAuthenticator($b, ($container->privates['security.user.provider.concrete.admins'] ?? $container->load('getSecurity_User_Provider_Concrete_AdminsService')), $c, $d, ['login_path' => 'app_admin_login', 'check_path' => 'app_admin_login', 'use_forward' => false, 'require_previous_session' => false, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'enable_csrf' => false, 'post_only' => true, 'form_only' => false]);

        if (isset($container->privates['security.authenticator.form_login.admin'])) {
            return $container->privates['security.authenticator.form_login.admin'];
        }

        return $container->privates['security.authenticator.form_login.admin'] = $instance;
    }
}
