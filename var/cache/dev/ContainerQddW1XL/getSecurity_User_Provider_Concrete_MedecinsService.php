 ...
 */
class getSecurity_User_Provider_Concrete_MedecinsService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.user.provider.concrete.medecins' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.medecins'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($container->services['doctrine'] ?? self::getDoctrineService($container)), 'App\\Entity\\Medecin', 'email', NULL);
    }
}
