 ...
 */
class getSecurity_User_Provider_Concrete_AdminsService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'security.user.provider.concrete.admins' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.admins'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider(($container->services['doctrine'] ?? self::getDoctrineService($container)), 'App\\Entity\\Admin', 'email', NULL);
    }
}
