...
class DemandeMedecin
{
    ...
    // Stored as comma-separated file paths
    #[ORM\Column(type: 'text', nullable: true)]
    ...
    #[ORM\Column(length: 255, nullable: true)]
    private ?string $carteService = null;
    ...
    public function setCarteIdentite(?string $carteIdentite): static
    {
    ...
    public function getCarteService(): ?string
    {
        return $this->carteService;
    }

    public function setCarteService(?string $carteService): static
    {
