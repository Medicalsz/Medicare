...
#[ORM\Entity(repositoryClass: \App\Repository\Donation\DonRepository::class)]
class Don
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'don', targetEntity: \App\Entity\Donation\ObjetDon::class, orphanRemoval: true, cascade: ['persist'])]
